...
//          element.before(picker);
  ...
  angular.module("datePicker").run(["$templateCache", function($templateCache) {
    ...
    $templateCache.put("templates/datepicker.html",
      ...
      "\n" +
      "        <th colspan=\"5\" class=\"switch\" ng-click=\"setView('month')\" ng-bind=\"date|date:'yyyy MM'\"></th>\r" +
      "\n" +
      ...
      "      <tr>\r" +
      "\n" +
      "        <th ng-repeat=\"day in ['一','二','三','四','五','六','日']\" style=\"overflow: hidden\" ng-bind='day'></th>\r" +
      "\n" +
      "      </tr>\r" +
      "\n" +
      "      </thead>\r" +
