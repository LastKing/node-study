...
(function() {
    ...
    var regModules = ['ng'],
        ...
        justLoaded = [],
        runBlocks = {},
        ocLazyLoad = angular.module('lazyload', ['ng']),
        broadcast = angular.noop;

    ocLazyLoad.provider('$lazyload', ['$controllerProvider', '$provide', '$compileProvider', '$filterProvider', '$injector', '$animateProvider',
...
function dependencies(moduleName,scriptUrl) {
    return ['$lazyload',function ($lazyload) {
